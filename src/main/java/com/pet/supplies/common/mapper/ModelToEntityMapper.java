...
public class ModelToEntityMapper {
	 ...
	 * @return
	 */
	public static Set<Orders> mapOrderModelsToOrderEntities(
	 ...
	 * @return
	 */
	public static AuthenticateUser mapAuthenticateUserModelToAuthenticateUserEntity(
	...
	public static Product mapProductModelToProductEntity(ProductModel model) {
		...
		if (model != null) {
			...
			product.setImageUrls(mapImageModelsToImageEntities(
					model.getImageUrls(), product));
		}
		return product;
	}

	public static Set<Image> mapImageModelsToImageEntities(
			Set<ImageModel> imageUrls, Product product) {
	 ...
	 * @return
	 */
	public static Image mapImageModelToImageEntity(ImageModel imageModel,
			Product product) {
	...
	public static Category mapCategoryModelToCategoryEntity(CategoryModel model) {
		Category category = new Category();
		if (model != null) {
			category.setCode(model.getCode());
			category.setName(model.getName());
			category.setSellerId(model.getSellerId());
		}
		return category;
	}
